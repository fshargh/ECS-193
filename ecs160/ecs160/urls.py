...
urlpatterns = [
    url(r'^warcraft/', 'warcraft.views.oldindex'),
    ...
    url(r'^accounts/profile/$', 'warcraft.views.profile'),
    ...
    url(r'^accounts/internalLogin/$', 'warcraft.views.internalLogin'),
    url(r'^accounts/internalLogout/$', 'warcraft.views.internalLogout'),
    url(r'^accounts/internalUpdate/$', 'warcraft.views.internalUpdate'),
     url(r'^accounts/friends/$', 'warcraft.views.friends'),
