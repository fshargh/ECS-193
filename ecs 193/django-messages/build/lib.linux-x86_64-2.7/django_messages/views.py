...
def inbox(request, template_name='django_messages/inbox.html'):
    ...
    return render_to_response(template_name, {
        'message_list': message_list, 'friendsname':friendsname
...
def compose(request, recipient=None, form_class=ComposeForm,
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if (email_to.emailEvery == 0):
              ...
              email_to.save()
              send_mail(subject, 'You  have a new message.', 'chriscraftecs193@gmail.com', [email_word], fail_silently=False, html_message=msg)
    ...
    return render_to_response(template_name, {
        'form': form, 'friendsname': friendsname
    }, context_instance=RequestContext(request))
